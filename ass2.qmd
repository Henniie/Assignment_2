...
Describe the dataset with the help of tables and graphics. First single variable with histograms, density plots etc.. Remember that you can use facets to group on different variables.
